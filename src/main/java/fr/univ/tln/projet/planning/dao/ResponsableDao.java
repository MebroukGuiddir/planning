...
import fr.univ.tln.projet.planning.modele.Responsable;
        ...
        { List<Utilisateur> listResponsable=new ArrayList();
            ...
            try (Connection connection = this.getConnection();
                 ...
                 PreparedStatement statement =
                         connection.prepareStatement("SELECT * FROM responsable r FULL JOIN utilisateur u ON r.id_user=u.id_user WHERE ( nom LIKE ?   OR  prenom LIKE ?  ) ")){
